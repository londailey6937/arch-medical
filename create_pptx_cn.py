...
OUTPUT = "/Users/londailey/arch-medical/Control_Tower_Sales_Deck_CN.pptx"
...
tab_data = [
    ...
    (3, "时间线", "项目管理", "timeline", [
     ...
     "控制塔的时间线专为510(k)项目打造，"
     "内置FDA术语和影响标记。"
     "MDUFA 90天径向时钟仪表（第15天RTA筛查 → 第60天审查 → 第90天决定）"
     "在FDA通讯标签页中跟踪，时间线标签页上还有迷你日期徽章。"
    ),
    ...
    (7, "FDA通讯中心", "法规监管", "fda-comms", [
        ...
        "▸ MDUFA 90天径向时钟仪表——颜色编码表盘（绿/琥珀/红）显示第X天 / 90，第15、60、90天标注里程碑；当FDA请求补充信息时自动暂停计时",
...
roles = [
    ("PMP (项目经理)", "完全访问所有17个标签页；FDA通讯独占权限", TEAL),
    ("技术", "技术/法规标签页、风险、文档、行动项、资源、消息板", ACCENT),
    ("商务", "商务里程碑、预算、投资、消息板", GREEN),
    ("财务", "预算、现金/跑道（有限编辑）", RGBColor(0x7B, 0x1F, 0xA2)),
]
...
tiers = [
    ...
    ("成长版 — $1,000/月", "5个席位", "除FDA通讯、美国投资外全部", ACCENT),
    ("规模版 — $2,000/月", "10个席位", "全部17个标签页含 FDA通讯 + 谓词查找器", NAVY),
]
...
add_text_box(slide, Inches(1.5), Inches(1.9), Inches(10), Inches(4.2), (
    ...
    "✓  自动化FDA Q-Sub生成、RTA预检查和MDUFA 90天径向时钟仪表 + 时间线日期徽章\n"
